...

{
   ...
   ret = dbus_bus_request_name(conn, "com.linuxdeepin.DMusic", DBUS_NAME_FLAG_REPLACE_EXISTING , &err);
   ...
   msg = dbus_message_new_signal("/com/linuxdeepin/DMusic", // object name of the signal

                                 "com.linuxdeepin.DMusic", // interface name of the signal

                                 "PlayPause"); // name of the signal
